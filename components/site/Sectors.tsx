        ...
        {sectors.map((sector, i) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 py-7 transition-transform duration-500 ease-out-strong motion-safe:group-hover:translate-x-3 sm:flex-row sm:items-baseline sm:gap-8 sm:py-8">
              ...
              <p className="text-[13px] leading-relaxed text-ink transition-colors duration-300 ease-out-strong group-hover:text-white sm:max-w-xs sm:text-right">
                {sector.detail}
              </p>
              ...
              <svg
                aria-hidden
                viewBox="0 0 16 16"
                className="hidden h-3.5 w-3.5 shrink-0 text-white/60 opacity-0 transition-all duration-300 ease-out-strong group-hover:opacity-100 motion-safe:-translate-x-2 motion-safe:group-hover:translate-x-0 sm:block"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
