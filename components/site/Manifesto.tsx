...
export function Manifesto() {
  ...
  return (
    <section aria-labelledby="manifesto-heading" className="relative isolate">
      ...
      <div className="border-y border-white/[0.05] bg-carbon">
      ...
      <div className="section-y mx-auto w-full max-w-5xl px-6 sm:px-8">
        ...
        <TextReveal className="text-[clamp(1.55rem,4vw,3rem)] font-medium leading-[1.18] tracking-tight text-white/80">
          {manifesto.statement}
        </TextReveal>
      </div>
    </section>
